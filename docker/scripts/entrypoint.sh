...
main() {
    printf "\n"
    printf "        ${BOLD}P A N T H E O N${NC}\n"
    printf "        ___________________\n"
    printf "       /\\                   \\\\\n"
    printf "      /  \\   ${CYAN}o${NC}     ${CYAN}o${NC}     ${CYAN}o${NC}   \\\\\n"
    printf "     /    \\  ${CYAN}|${NC}     ${CYAN}|${NC}     ${CYAN}|${NC}   \\\\\n"
    printf "    /______\\ ${CYAN}|${NC}     ${CYAN}|${NC}     ${CYAN}|${NC}   \\\\\n"
    printf "    |      | ${CYAN}|${NC}     ${CYAN}|${NC}     ${CYAN}|${NC}    |\n"
    printf "    |      | ${CYAN}|${NC}     ${CYAN}|${NC}     ${CYAN}|${NC}    |\n"
    printf "    |______|_${CYAN}|${NC}_____${CYAN}|${NC}_____${CYAN}|${NC}____|\n"
    printf "\n"
    printf "        ${BOLD}ClaudePantheon${NC}\n"
    printf "        A RandomSynergy Production\n"
    printf "        Your consciousness persists here.\n"
    printf "\n"
